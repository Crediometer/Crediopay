                    ...
                    <div className="right">
                        ...
                        {(!business) && (
                            <div className={styles.completeProfile}>
                                <p>Your profile hasn't been fully completed yet. Please click this button to finalize it:<Link to="/activate"><button>Complete</button></Link></p>
                            </div>
                        )}
                        <div className="content" style={{ marginTop: !business && "0px"}}>
