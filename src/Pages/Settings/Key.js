...
const Key = ({fetchgetprofile, putwebhook, clientid,apiKey, error, loading, personal, business, webhookurl}) => {
                        ...
                        <div className="secret-key-form">
                            <div className="secret-input">
                                <input
                                    ...
                                    defaultValue={(business?.length !== 0) ? (webhookurl ) : ("xxxxxxxxxxxxxx")}
                                    required
                                >
                                </input>
                                <div className="secret-icon">
...
const mapStoreToProps = (state) => {
    ...
    return {
        ...
        webhookurl: state?.getprofile?.data?.client?.webhookURL,
