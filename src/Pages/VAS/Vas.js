                                ...
                                {data?.map((service)=>{
                                    return(
                                        <div className="service" onClick={()=>{
                                            {(service._id === "61e985a3bce8e444a4976643") && (handleElectricity(service._id))}
                                            {(service._id === "61e985180e69308aa37a7a94") && (handleAirtime(service._id))} 
                                            {(service._id === "61e9854bbce8e444a497663e") && (handleData(service._id))}
                                            {(service._id === "61e9857bbce8e444a4976641") && (handleCable(service._id))}
                                        }}>
                                            <div className="service-icon phone-icon">
                                                {(service._id === "61e985a3bce8e444a4976643") && (
                                                ...
                                                {(service._id === "61e985180e69308aa37a7a94") && (<FaPhoneAlt/>)}
                                                {(service._id === "61e9854bbce8e444a497663e") && (<RiWifiFill/>)}
                                                {(service._id === "61e9857bbce8e444a4976641") && (
