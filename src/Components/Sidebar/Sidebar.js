            ...
            <section className={styles.links}>
                <nav>
                    {SidebarDetails.map((val, index)=>{
                        ...
                        <li>
                            <a href="https://documenter.getpostman.com/view/11125626/2sA3Bt1pKS"
                                className={classNames(styles.navLink, { [styles.active]: location.pathname === 'https://documenter.getpostman.com/view/11125626/2sA3Bt1pKS' })}
                                onClick={toggle}
                                target="_blank"
                                // onClick={(event) => handleLinkClick(event, index)}
                                // className={activeLink === index ? 'active' : ''}
